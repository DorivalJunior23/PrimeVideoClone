...
import { MoviesCard } from "../../components/MoviesCards/index";
...
export const Home = () =>{
    return (
        <View style={styles.container}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} showsHorizontalScrollIndicator={false} style={styles.contentMovies}>
            <TouchableOpacity style={styles.moviesImageThumbnail}>
                <Image source={MovieTheWhell} style={styles.moviesImage}/>
            </TouchableOpacity>
